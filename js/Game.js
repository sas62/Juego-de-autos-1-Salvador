class Game {
  ...
  start() {
    ...
    var obstacle1Positions=[
      ...
      {x:width/2 - 180, y: height-1300,image:obstacle1Image},
      {x:width/2 - 150, y: height-1300,image:obstacle1Image},
      {x:width/2, y: height-5300,image:obstacle1Image}
    ]

    var obstacle2Positions=[
      {x:width/2 - 80, y: height-1300,image:obstacle2Image},
      {x:width/2 + 200, y: height-1800,image:obstacle2Image},
      {x:width/2 - 140, y: height-1300,image:obstacle2Image},
      {x:width/2 - 110, y: height-1300,image:obstacle2Image},
